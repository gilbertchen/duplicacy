...
func (storage *GCSStorage) shouldRetry(backoff *int, err error) (bool, error) {
	...
	util.LOG_INFO("GCS_RETRY", "%s; retrying after %.2f seconds", message, delay)
...
func (storage *GCSStorage) DownloadFile(threadIndex int, filePath string, chunk io.Writer) (err error) {
